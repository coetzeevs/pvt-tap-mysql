...
class MySQLConnector(SQLConnector):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        self._table_cols_cache: dict[str | FullyQualifiedName, dict[str, sqlalchemy.Column]] = {}
...
class MySQLStream(SQLStream):
    ...
    def get_records(self, context: Mapping[str, Any] | None) -> Iterable[dict[str, Any]]:  # type: ignore[override]
